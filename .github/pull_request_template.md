...
<!--
Informe a Issue relacionada quando aplicável.

Exemplo:
Closes #123

Use "Closes", "Fixes" ou "Resolves" quando o merge deste PR concluir a Issue.
Remova esta seção quando não houver Issue relacionada.
-->
...
Para mudanças simples, uma ou duas frases são suficientes.
Para mudanças maiores, destaque decisões, limitações ou impactos relevantes.
-->

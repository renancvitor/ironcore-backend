...
public class GetUserBodyMetricsControllerTest {
    ...
    void shouldReturnUserBodyMetricsById() throws Exception {
        ...
        GetUserBodyMetricsResult result = new GetUserBodyMetricsResult(
                new UserBodyMetricsId(1L),
                new UserId(1L),
        ...
        when(getUserBodyMetricsUseCase.execute(command))
                .thenReturn(result);
        ...
        verify(getUserBodyMetricsUseCase).execute(command);
    }
